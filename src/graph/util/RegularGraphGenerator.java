...
public class RegularGraphGenerator {
     ...
     */
    public <G extends Graph> G getRandomGraph(Class<G> clazz, int verticesNumber, int degree) throws IllegalArgumentException {
     ...
     * @throws IllegalArgumentException if graph from given parameters cannot be constructed
     */
    public <G extends Graph> G getRandomGraph(Class<G> clazz,
    ...
    protected <G extends Graph> G getGraphA1(Class<G> clazz, int verticesNumber, int degree) {
        G g = GraphFactory.getInstance(clazz, verticesNumber);
        do {
            /*
    ...
    private <G extends Graph> G getGraphA2(Class<G> clazz, int verticesNumber, int degree) {
        //TODO
        ...
        do {
             ...
             */
            g = GraphFactory.getInstance(clazz, verticesNumber);
